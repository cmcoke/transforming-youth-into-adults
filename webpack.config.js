...
let config = {
  ...
  entry: {
    ...
    donation_form: path.resolve(__dirname, './src/assets/scripts/modules/DonationForm.js'),
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['about_us_page_animation', 'join_us_page_animation', 'services_page_animation', 'events_page_animation', 'donate_page_animation', 'donation_form', 'modal']
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['home_page_animation', 'join_us_page_animation', 'services_page_animation', 'events_page_animation', 'donate_page_animation', 'donation_form', 'modal']
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['home_page_animation', 'about_us_page_animation', 'services_page_animation', 'events_page_animation', 'donate_page_animation', 'donation_form']
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['home_page_animation', 'about_us_page_animation', 'join_us_page_animation', 'events_page_animation', 'donate_page_animation', 'donation_form', 'modal']
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['home_page_animation', 'about_us_page_animation', 'join_us_page_animation', 'services_page_animation', 'donate_page_animation', 'donation_form', 'modal']
    }),
    ...
    new HtmlWebpackPlugin({
      ...
      excludeChunks: ['home_page_animation', 'about_us_page_animation', 'join_us_page_animation', 'services_page_animation', 'events_page_animation', 'donate_page_animation', 'donation_form', 'modal']
    }),
...
if(currentTask == 'build'){
  ...
  config.plugins.push(
    ...
    new MiniCssExtractPlugin({ // extracts the css file from main.js
