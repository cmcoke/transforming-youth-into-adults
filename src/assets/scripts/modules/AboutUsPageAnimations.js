...
class AboutUsPageAnimations {
  ...
  AboutUsPage() {
    // hero section
    this.hero.to("#about-us-page-hero-title", { opacity: 1 }, 0.5);

    // second section
    this.secondSection.to("#about-us-page-second-section-first-text-content", { opacity: 1, duration: 1 });
    this.secondSection.to("#about-us-page-second-section-second-text-content", { opacity: 1, duration: 1 }, "+=1.4");
    ...
    this.thirdSection.from("#about-us-page-third-section-first-content", { opacity: 0, duration: 0.5, xPercent: 200 });
    this.thirdSection.from("#about-us-page-third-section-second-content", { opacity: 0, duration: 0.5, xPercent: -200 }, "+=1");
    this.thirdSection.from("#about-us-page-third-section-third-content", { opacity: 0, duration: 0.5, xPercent: 200 }, "+=1");
